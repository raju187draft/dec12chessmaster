...
// Validate ../../../app/api/analyze-move/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/analyze-move">> = Specific
  const handler = {} as typeof import("../../../app/api/analyze-move/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
